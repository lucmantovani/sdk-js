...
<table>
    ...
    <tr>
        <td rowspan="2">expirationMonth</td>
        <td>invalid_type</td>
    ...
    <tr>
        <td rowspan="3">expirationYear</td>
        <td>invalid_type</td>
    ...
    <tr>
        <td rowspan="3">expirationDate</td>
        <td colspan="2" style="padding: 16px"><center>expirationMonth and expirationYear causes and messages.</center></td>
    </tr>
</table>
